...
app.get('/:sandboxPath', authMiddleware, (req,res)=>{ // path traversal
...
app.post('/:sandboxPath', authMiddleware, (req, res)=>{
    ...
    if(!saveOptions.ext.includes('.ejs') || saveOptions.ext.length !== 4) isChecked = false; // {ext:[".ejs","sdf","sdf","dsf"]} bypass
